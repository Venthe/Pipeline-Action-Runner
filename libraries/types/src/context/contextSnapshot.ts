...
export type InternalSnapshot = StaticInternalSnapshot & DynamicInternalSnapshot & Partial<DeprecatedInternalSnapshot>;
export type StaticInternalSnapshot  = JobInternalSnapshot & SystemInternalSnapshot & EventInternalSnapshot & ActorInternalSnapshot & RepositoryInternalSnapshot & WorkflowExecutionInternalSnapshot
export type DynamicInternalSnapshot = Partial<CurrentActionInternalSnapshot>

export interface SystemInternalSnapshot {
  /**
...
export interface EventInternalSnapshot {
  /**
  ...
  /**
   * The type of the event that triggered the workflow run.
   **/
  eventName: string;
}

interface JobInternalSnapshot {
  /**
...
interface WorkflowExecutionInternalSnapshot {
  /**
  ...
  /**
   * The ref path to the workflow. For example, octocat/hello-world@refs/heads/my_branch:.github/workflows/my-workflow.yml
   */
  workflowRef: string;
...
interface RepositoryInternalSnapshot {
...
interface ActorInternalSnapshot {
  /**
...
interface CurrentActionInternalSnapshot {
  /**
...
interface DeprecatedInternalSnapshot {
  /**
   ...
   * For more information, see "Events that trigger workflows." For example, ffac537e6cbbf934b08745a378932722df287a53.
   * 
   * @Deprecated
   **/
  sha: string;
   ...
   * @deprecated
   **/
  secretSource: "None" | "Actions" | "Codespaces" | "Dependabot";
}
